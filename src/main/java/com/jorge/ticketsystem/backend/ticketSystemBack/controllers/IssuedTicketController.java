...
public class IssuedTicketController {
    ...
    // 3. OBTENER TODOS PAGINADOS (GET) ->
    // /api/v1/issued-tickets?page=0&size=10&sort=id,desc
    @GetMapping
    ...
    public ResponseEntity<QrResponseDto>validarTicket(@Valid @RequestBody IssuedTicketValidationDto scanDto){

       QrResponseDto response = issuedTicketService.validateQr(scanDto);
